<script>
	...
	let columns = [
		...
		{key: 'variation_description', title: textVars.columnsText.variation_description, type: 'html'},
		{key: 'weight_html', title: textVars.columnsText.weight_html, type: 'text'},
...
<div id="variations">
	<Filters bind:searchQuery="{searchQuery}" 
	...
	<table class="variations">
		...
		<tbody>
			...
			{#if !filteredData || !filteredData.length}
				<tr>
					<td colspan="{activeColumnsNum}" style="text-align: center;">{textVars.noResultsText}</td>
				</tr>
			{/if}
		</tbody>
	</table>
